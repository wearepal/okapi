...
from typing import Any, Dict, Final, Optional, Tuple, Union, cast, overload
...
from src.models.base import BackboneFactory, Model, ModelFactoryOut, PredictorFactory
from src.models.meta import MetaModel
    ...
    *,
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        if artifact_name is None:
            artifact_name = cast(
                str, (config["dm"]["_target_"].split(".")[-1].removesuffix("DataModule").lower())
            )
            artifact_name += "_"
